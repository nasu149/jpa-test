...
REM -------------------------------------------------------------------------
REM  Red Hat JBoss EAP 8 Service Script for Windows
...
rem defaults
set SHORTNAME=JBossEAP8
set DISPLAYNAME=JBossEAP8
rem NO quotes around the description here !
set DESCRIPTION=JBoss Enterprise Application Platform 8
...
:cmdUsage
echo Red Hat JBoss EAP 8 Service Script for Windows
echo Usage:
echo(
